...
참조변수의 형 변환은 무엇인가? 이는 어떠한 타입의 참조변수를 사용할 것인지를 정해주는 작업이라 할 수 있다. 이때, 어떠한 타입의 참조변수를 사용하느냐에 따라, 인스턴스에서 사용할 수 있는 멤버의 개수가 달라지기 때문에<br>

**결론적으로, 참조변수의 형 변환은 사용할 수 있는 멤버의 개수를 조절해주는 작업 이라고 할 수 있게 된다.**<br>
