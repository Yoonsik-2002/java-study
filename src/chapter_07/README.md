...
![스크린샷(2)](https://github.com/Yoonsik-2002/java-study/assets/83572199/92fccaf3-a0a7-4348-8ceb-7a69bf72c542)<br>
<br>
...
먼저, `Marine`클래스와 `Tank`클래스는 지상 유닛이지만, `DropShip`클래스는 공중 유닛으로, 서로 이동하는 방법이 다르다는 차이점이 존재한다. 때문에, 이동 기능을 구현하는 `move`메서드의 경우, 실제 기능 구현을 담당하는 메서드의 구현부의 내용이 클래스 간 다를 수 있다.<br>
