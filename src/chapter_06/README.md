...
결국 `PrintStream`클래스 내에 오버로딩되어 정의되어 있는 10개의 서로 다른 타입의 매개변수를 지닌 메서드들 중에서,<br>
지정한 타입의 매개변수를 지닌 `println()`메서드가 호출되는 것이다.<br><br>

![스크린샷(2)](https://github.com/Yoonsik-2002/java-study/assets/83572199/e4806931-ed83-455d-a5d6-1de6c3df8985)
