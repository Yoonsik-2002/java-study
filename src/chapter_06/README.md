...
이 선언위치에 따른 변수의 종류에 대해, 아래 코드와 표를 통해 정리해 보았다.<br>
...
- #### 인스턴스 변수 (instance variable)
  ...
  - 특징 -<br>
     ...
     4) 인스턴스 마다, 각기 다른 별도의 저장공간을 가지기 때문에, 인스턴스 변수를 통해 각 <br>
        인스턴스들에 서로 다른 속성값을 저장시키는 것이 가능하다.
     5) 인스턴스 마다 고유한 상태를 유지해야 하는 속성의 경우, 인스턴스 변수로 선언한다. 
